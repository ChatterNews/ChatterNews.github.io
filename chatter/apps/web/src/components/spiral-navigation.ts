...
export const SPIRAL_ROOMS: readonly SpiralRoom[] = [
  ...
  { slug: 'studio', name: 'Studio', verb: 'Score it', mark: 'ST', group: 'MAKE', color: '#ff6fb3' },
  ...
  { slug: 'stinger', name: 'Stinger', verb: 'Signal it', mark: 'SG', group: 'MAKE', color: '#ffd64c' },
  { slug: 'showtime', name: 'Showtime', verb: 'Cut it', mark: 'SH', group: 'MAKE', color: '#ff925f' },
...
export const SPIRAL_ROOM_PURPOSES: Readonly<Record<string, string>> = {
  ...
  studio: 'Build music and shape audio.',
  chatterbox: 'Record and edit a podcast.',
  blast: 'Design pages, flyers, and covers.',
  stinger: 'Build graphics for the screen.',
  showtime: 'Record and edit the final video.',
